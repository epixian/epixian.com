...
{{--                 <div class="flex items-center justify-around mb-8 mx-auto">
                ...
                <div id="mc_embed_signup" class="mb-8">
                <form action="https://epixian.us18.list-manage.com/subscribe/post?u=ccc578b232f59af0c7ac81862&amp;id=833dc73201" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
                    <div id="mc_embed_signup_scroll" class="flex hover:shadow-xl inline-flex items-center max-w-xs mc-field-group w-full">
                        <div class="flex-1">
                            <input type="email" value="" name="EMAIL" class="email px-4 py-2 required rounded-l shadow text-gray-900 w-full" id="mce-EMAIL" placeholder="Email">
                        </div>
                        ...
                        <div style="position: absolute; left: -5000px;" aria-hidden="true" class="w-0"><input type="text" name="b_ccc578b232f59af0c7ac81862_833dc73201" tabindex="-1" value="" class="w-0"></div>
